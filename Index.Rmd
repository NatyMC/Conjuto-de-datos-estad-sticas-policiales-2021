...
Datos_policiales <-
 readxl::read_excel(
    path = ("C:/Users/Fabiana/OneDrive/Documentos/Fabiana IMPORTANTE/Cursos Universidad/Procesamiento de datos Geo I/Tarea 2/Datos policiales.xls"),
    sheet = ";",
    col_select = c("Delito", "Fecha", "Victima", "Edad", "Genero", "Provincia", "Cantón")
  )
